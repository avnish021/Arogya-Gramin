    ...
    <div class="col-lg-4 col-md-5 col-sm-5">
      ...
      <div class="hs_contact">
        <ul style="list-style-type:none;">
		  ...
		  <hr>
          <li> 
            <p style="font-weight:bold"><i class="fa fa-phone"></i>&nbsp;&nbsp; Toll Free General Enquiry - 1800 8906600</p>
            <p style="font-weight:bold"><i class="fa fa-phone"></i>&nbsp;&nbsp; Healthcard/ Medical - 1800 8898286 </p>
          </li>
		  <hr>
          <li>
  ...
  <div class="row" style="margin-top:40px;">
    <div class="col-lg-12">
      <div class="hs_contact_head_text">
        <h3 ><b>Department Email ID For Support</b></h3><hr>
        <p></p>
      </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
     <h4><b>Healthcard/Medical - </b>1800 8898 286 (support@arogyagramin.com)</h4><hr>
     
     <h4><b>Healthcard/IT Support - </b>arogyagraminit@gmail.com</h4><hr>
