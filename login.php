<?php require_once "user/controllerUserData.php"; ?>
<?php 
session_start();
?>
<!DOCTYPE html>
...
})(window,document,'script','dataLayer','GTM-WDFVDPC');</script>
<!-- End Google Tag Manager -->
</head>
<body>
    
    <!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WDFVDPC"
...
<div class="header-bot">
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<div class="col-md-4 agileits-social top_content" style="margin-top:20px;">
           <center> <a href="login.php" class="btn btn-danger" style="margin-top:7px;">Apply For Health Card</a>
...
<!-- Modal1 -->
    ...
    <button class='btn btn-info' style="margin-top:7px;"><a href="volunteer/login.php" style="color:white">Partner Login</a></button>  &nbsp;&nbsp;
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form action="login_user.php" method="POST" autocomplete="">
                   ...
                   <br> <p class="text-center">Login with your email and password.</p></br>
                    <?php
                    if(count($errors) > 0){
                        ?>
                    ...
                    <div class="link forget-pass text-right"><a href="user/forgot_password.php">Forgot password?</a></div><br>
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="login" value="Login">
                    </div>
                    <div class="link login-link text-center">Not yet a member? <a href="user/registration.php">Signup now</a></div><br>
                    
                    <button class='btn btn-info' style="margin-top:7px;"><a href="index.php" style="color:white">Home</a></button>  &nbsp;&nbsp;<br></br>
                </form>
            </div>
        </div>
    </div>
...
$conn->close();
?>
<div class="footer" style="background:#00B050;color:white">
...
<form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_ILoQSsX3a0xc4O" async> </script> </form>
