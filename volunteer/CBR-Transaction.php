...
h3{
    ...
    font-size:12px;
      ...
      <table id="example">
        ...
        foreach($obj->getResult() as list("ID"=>$id,"V_NAME"=>$name,"AMOUNT_EVERY_CARD"=>$rate,"DISCOUNT"=>$discount
        ,"WALLET_AMOUNT"=>$walletA,"PAYMENT_STATUS"=>$status,"RAZORPAY_PAYMENT_ID"=>$paymentId,"DATE"=>$date,"TOTAL_AMOUNT"=>$TOTAL_AMOUNT)){
          ?>
<tr>
