...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<div class='col-md-10' id='h' style='margin:auto;background-image:url(../assets/images/slider/0001.jpg);background-size:100% 100%;height:500px;margin-top:20px;'><div id='card'><br><br><br><br><br><span style='font-weight:bold;'>".$row['name']."<span><br><br><span style='font-weight:bold;'>".$row['application_no']."<span><br><hr><span style='font-weight:bold;'>".$row['gander']."<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-weight:bold;'>".$row['dob']."<span><br><hr><span style='font-weight:bold;'>".$row['full_address']."<span><br><hr><span style='font-weight:bold;'> 1 Year (".$row['startdate']." To ".$row['enddate'].")<span></div></div>  <div class='col-md-12 ' id='s' style='margin:auto;background-image:url(../assets/images/slider/0001.JPG);background-size:100% 100%;height:300px;margin-top:20px;'><div id='card'><br><br><br><span style='font-weight:bold;'>".$row['name']."<span><br><br><span style='font-weight:bold;'>".$row['application_no']."<span><br><br><span style='font-weight:bold;'>".$row['gander']."<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='font-weight:bold;'>".$row['dob']."<span><br><br><span style='font-weight:bold;'>".$row['full_address']." <span><br><span style='font-weight:bold;'> 1 Year (".$row['startdate']." To ".$row['enddate'].")<span></div></div><div class='col-md-10 ' id='h' style='margin:auto;background-image:url(../assets/images/slider/0004.jpg);background-size:100% 100%;height:500px;margin-top:20px;'></div><div class='col-md-12' id='s' style='margin:auto;background-image:url(../assets/images/slider/0004.jpg);background-size:100% 100%;height:500px;margin-top:20px;'></div>";
    }
} else {
