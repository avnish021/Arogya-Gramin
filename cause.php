...
<section class="donate-section-2 bd-bottom padding bg-grey">
    <div class="container">
        <div class="section-heading mb-40 text-center">
            <span class="sub-heading">Recent Campaigns!</span>
            <h2>Fundraising For The People And <br>Causes You Care About!</h2>
            <p>We are working fast on the related factors to cure all the causes and cases which prevent the development of the society.<br>We really need your support so that we can improve our work process. Donate us and be the participant of our donnar family. </p>
        </div><!-- /.section-heading -->
        <div class="donate-wrap row">
            <div class="col-lg-4 col-md-6 padding-15">
                <div class="donate-box">
                    <div class="donate-img">
                        <img src="assets/new/img/donation-1.jpg" alt="donate">
            ...
            <div class="col-lg-4 col-md-6 padding-15">
                <div class="donate-box">
                    <div class="donate-img">
                        <img src="assets/new/img/donation-2.jpg" alt="donate">
                        <div class="donate-btn btn-2">
                            <a href="donation_page.php">Donate Now</a>
                        </div>
                        <div class="progress">
                    ...
                    <div class="donate-content">
                        <span class="desc">Association</span>
                        <a href="#">
                            <h3>Medicare Support<br>Near Them</h3>
                        </a>
                        <p> To provide all types of medicare supprt at Hospital, Clinic, Lab and Medical store near them. We need improve our association process and associates maximum of healthcare institution. </p>
                        <ul class="donate-list">
                            <li><i class="ti-bar-chart"></i>GOAL: Rs.1,50,000</li>
                            <!--<li><i class="ti-thumb-up"></i>RAISED: $201,960</li>-->
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 padding-15">
                <div class="donate-box">
                    <div class="donate-img">
                        <img src="assets/new/img/donation-3.jpg" alt="donate">
                        <div class="donate-btn btn-3">
                            <a href="donation_page.php">Donate Now</a>
                        </div>
                        <div class="progress">
                    ...
                    <div class="donate-content">
                        <span class="desc-2">Camping</span>
                        <a href="#">
            ...
            <div class="col-lg-4 col-md-6 padding-15">
                <div class="donate-box">
                    <div class="donate-img">
                        <img src="assets/new/img/donation-4.jpg" alt="donate">
                        <div class="donate-btn btn-4">
                            <a href="donation_page.php">Donate Now</a>
                        </div>
                        <div class="progress">
                    ...
                    <div class="donate-content">
                        <span class="desc-3">Stuff</span>
                        <a href="#">
                            <h3>Distributing Healthcare Stuff's For People</h3>
                        </a>
            ...
            <div class="col-lg-4 col-md-6 padding-15">
                <div class="donate-box">
                    <div class="donate-img">
                        <img src="assets/new/img/donation-5.jpg" alt="donate">
                        <div class="donate-btn btn-5">
                            <a href="donation_page.php">Donate Now</a>
                        </div>
                        <div class="progress">
                    ...
                    <div class="donate-content">
                        <span class="desc-4">Manpower</span>
                        <a href="#">
                            <h3>Finance suppport to our Volunteer</h3>
                        </a>
            ...
            <div class="col-lg-4 col-md-6 padding-15">
                <div class="donate-box">
                    <div class="donate-img">
                        <img src="assets/new/img/donation-6.jpg" alt="donate">
                        <div class="donate-btn btn-6">
                            <a href="donation_page.php">Donate Now</a>
                        </div>
                        <div class="progress">
                    ...
                    <div class="donate-content">
                        <span class="desc-5">Skill Development</span>
                        <a href="#">
