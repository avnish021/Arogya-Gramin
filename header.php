...
src="https://www.facebook.com/tr?id=631993320792590&ev=PageView&noscript=1"
/></noscript>
...
<!-- header -->
<div class="container-fluid" style="background:#008080;font-weight:600;color:black">
    <div class="container">
...
<div class="header-bot">
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<div class="col-md-4 agileits-social top_content" style="margin-top:20px;">
           <center> <a href="apply_healthcard2.php" class="btn btn-danger" style="margin-top:7px;">Apply For Health Card</a>
...
<!-- //header-bot -->
<!-- banner -->
<div class="ban-top" style="background:#ff5733;font-weight:600;color:black">
				  ...
				  <ul class="nav navbar-nav menu__list">
                    ...
                    <li class="menu__item dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">Other<b class="caret"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="https://www.https://www.facebook.com/arogyagraminhealthcarefoundation/" target=”_blank”>Facebook</a></li>
									<li><a href="https://www.youtube.com/channel/UCWuHT2-20eeI39or16hqiDg">You Tube</a></li>
                                    <li><a href="https://www.linkedin.com/company/arogyagramin">Linkdin</a></li>
                                    <li><a href="https://twitter.com/GraminCare">Twitter</a></li>
								</ul>
					</li>
                    <!--<li class="menu__item dropdown">
