        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form action="login_user.php" method="POST" autocomplete="">
                    ...
                    <div class="link forget-pass text-left"><a href="user/forgot_password.php">Forgot password?</a></div>
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="login" value="Login">
                    </div>
                    <div class="link login-link text-center">Not yet a member? <a href="registration.php">Signup now</a><br></div>
