...
<div class="agile_last_double_sectionw3ls">
	...
	<section class="cta-section bd-bottom">
		<div class="containertwo">
			<div class="row align-items-center">
				<div class="col-md-6 sm-padding">
					<form action="book_op.php" method="post" id="volunteer-form" class="form-horizontal appointment-form" style="width:30rem">
				...
				<div class="col-md-6 sm-padding">
					<form action="book_op.php" method="post" id="volunteer-form" class="form-horizontal appointment-form mb-3" style="width:30rem">
	...
	<!--<br><center><a href=""><img src="images/Republic Day 3.jpg" style="width:100%" alt="" /></a></center> </br>
	   ...
	   <!--What's App Button-->
	<a href="https://wa.me/message/QVWBOLAHFLZIA1" style="display: table; font-family: sans-serif; text-decoration: none; margin: 1em auto; color: #fff; font-size: 0.9em; padding: 1em 2em 1em 3.5em; border-radius: 2em; font-weight: bold; background: #25d366 url('') no-repeat 1.5em center; background-size: 1.6em;">Chat
