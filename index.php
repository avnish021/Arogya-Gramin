...
<div class="agile_last_double_sectionw3ls" style="margin-top:20px;">
	<div class="container">
		<h4 style="text-align:center;font-weight:500;color:rgba(0,0,0,0.40)">
			Organization strictly opposed any type of fraudulent activity please do any work after verification. <br>किसी भी प्रकार की धोखाधड़ी गतिविधि का संगठन कड़ा विरोध करता है कृपया सत्यापन के बाद हीं कोई कार्य करें। के बाद ही कोई कार्य करें।<br>
		</h4>
		<hr>
	</div>
				...
				<div class="col-md-6 sm-padding">
					<div class="section-heading text-left mb-20">
						...
						<ul class="about-list mb-20">
							...
							<li><i class="fas fa-thumbs-up"></i>Building a healthy society and ensuring their access to health sectors.</li>
						</ul>
					</div><!-- /.section-heading -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 sm-padding">
                    <form action="book_op.php" method="post" id="volunteer-form" class="form-horizontal appointment-form">
						...
						<div class="form-group row mt-1">
							<div class="col-12">
                                <input type="text" id="volunteer-form-phone" name="phone" class="form-control" placeholder="Phone No" 
								onKeyPress="if(this.value.length==10) return false;" min="10" required>
                            </div>
						</div>
						<div class="form-group row mt-1">
                            <div class="col-sm-12">
                        ...
                        <button id="volunteer-submit" class="default-btn" name="save" type="submit">Submit <span></span></button>
	...
	<!--<br><center><a href=""><img src="images/Republic Day 3.jpg" style="width:100%" alt="" /></a></center> </br>
	   ...
	   <!--What's App Button-->
	<a href="https://wa.me/message/QVWBOLAHFLZIA1" style="display: table; font-family: sans-serif; text-decoration: none; margin: 1em auto; color: #fff; font-size: 0.9em; padding: 1em 2em 1em 3.5em; border-radius: 2em; font-weight: bold; background: #25d366 url('') no-repeat 1.5em center; background-size: 1.6em;">Chat us For Business Partnership</a>
					...
					<div class="row" style="background-image:url(images/ap02.jpg);background-size:100% 100%;">
						...
						<div class="col-sm-8" style="background:rgba(192,192,192,0.6);">
							...
							<form action="book_op.php" method="post" style="margin-top:20px;margin-bottom:20px;width:90%;">
								...
								<input type="email" id="slider_email" name="email" class="form-control" placeholder="Email (required)" required><br>
...
<div class="container">
	<div class="row" style="margin-top:50px">
		...
		<div class="col-sm-12" style="background:rgba(0,0,0,0.40);text-align:justify;padding:16px;color:white">
			<p>Arogya Gramin Healthcare Foundation is ISO 9001: 2015 certified and registered under the Government of Indian Act 2013.</p>
			<br>
			<p>This organization is working within the Government of India to make healthcare facilities reach more and more people at a lower cost.</p>
			<br>
			<p>
				Our organization is fully operational in rural and urban areas and we are trying to establish our branch in different areas of the country.
			</p>
			<br>
	...
	<div class="row" style="margin-top:50px">
		...
		<div class="col-sm-3" style="margin-top:20px;">
			<center>
				...
				<span>(Founder & CEO) 7 years of work experience and knowledge of 10 projects which are currently successfully running.</span>
				<hr>
			</center>
		</div>
		<div class="col-sm-3" style="margin-top:20px;">
...
<div class="container">
	<div class="row" style="margin-top:50px">
		...
		<br>
		<marquee>
			<div class="our_partners_slider_item"> <img src="assets/images/partner/1.jpg" alt="" width="100" height="70" /> </div>
			<div class="our_partners_slider_item"> <img src="assets/images/partner/2.png" alt="" width="100" height="70" /> </div>
			<div class="our_partners_slider_item"> <img src="assets/images/partner/3.png" alt="" width="100" height="70" /> </div>
			<div class="our_partners_slider_item"> <img src="assets/images/partner/4.png" alt="" width="100" height="70" /> </div>
			<div class="our_partners_slider_item"> <img src="assets/images/partner/5.jpg" alt="" width="100" height="70" /> </div>
			<div class="our_partners_slider_item"> <img src="assets/images/partner/6.png" alt="" width="100" height="70" /> </div>
			<div class="our_partners_slider_item"> <img src="assets/images/partner/7.png" alt="" width="100" height="70" /> </div>
		</marquee>
	</div>
</div>
<!--<div class="container-fluid">
