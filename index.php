            ...
            <div class="container">
                <div class="slider-content">
					...
					<div class="dl-btn-group">
						<div class="inner-layer">
							<a href="cause-single.html" class="default-btn" data-animation="fade-in-bottom" data-delay="2.5s">Make a Donation<span></span><i class="arrow_right"></i></a>
						</div>
					</div> -->
                </div>
            </div>
...
<div class="agile_last_double_sectionw3ls">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 sm-padding">
                    <form action="book_op.php" method="post" id="volunteer-form"
                        class="form-horizontal appointment-form" style="width:30rem">
                        ...
                        <div class="form-group row">
                            ...
                            <marquee width="100%" direction="up" height="350px" behavior="scroll" scrollamount="3" vspace="20%">

                                <div class="card boxshadow">
                                    <div class="card-body">
                                        <h5 class="card-title font-weight-bold">Healthcard</h5>
                                        <h6 class="card-subtitle mb-2 text-muted">To get benefits from our
                                            healthcard</h6>
                                        <p class="card-text"> http://arogyagramin.com/user/application_form.php.</p>

                                    </div>
                                </div>

                                <div class="card boxshadow mt-2">
                                    <div class="card-body">
                                        <h5 class="card-title font-weight-bold">Franchise Partner</h5>
                                        <h6 class="card-subtitle mb-2 text-muted">To start your own Business</h6>
                                        <p class="card-text">
                                            https://drive.google.com/file/d/1FvLJlWuDso-kwssEUIt8bKyKEoJeICaG/view?usp=sharing.
                                        </p>
                                ...
                                <div class="card boxshadow mt-2">
                                    <div class="card-body">
                                        <h5 class="card-title font-weight-bold">Tele Caller</h5>
                                        <h6 class="card-subtitle mb-2 text-muted"> Calling office work</h6>
                                        <p class="card-text"> http://arogyagramin.com/career.php</p>
                ...
                <div class="col-md-6 sm-padding">
                    <form action="book_op.php" method="post" id="volunteer-form"
                        class="form-horizontal appointment-form mb-3" style="width:30rem">
    ...
    <br>
    <center> <a href="https://drive.google.com/file/d/1A0oLXBXp-KKL8hBr4k8qGVfX3e9IazjK/view?usp=sharing">
            <p style="color:orange;font-weight:bold;font-size:30px;"> </p>
    </center>
    </a>
    <!--<br><center><a href=""><img src="images/Republic Day 3.jpg" style="width:100%" alt="" /></a></center> </br>
	   	
	   <!--What's App Button-->
    <a href="https://wa.me/message/QVWBOLAHFLZIA1"
        style="display: table; font-family: sans-serif; text-decoration: none; margin: 1em auto; color: #fff; font-size: 0.9em; padding: 1em 2em 1em 3.5em; border-radius: 2em; font-weight: bold; background: #25d366 url('') no-repeat 1.5em center; background-size: 1.6em;">Chat
        us For Business Partnership</a>

    <div class="agile_last_double_sectionw3ls" style="margin-top:30px;">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h3><b><u>Our Goal</u></b></h3>
                    <ul><br />
                        <li>Our customers and their safety are paramount in everything we do.</li>
                        <hr />
                        <li>We care about the community.</li>
                        <hr />
                        <li>We care about the environment.</li>
                        <hr />
                        <li>Our people are our strength.</li>
                        <hr />
                        <li>We work ethically and professionally.</li>
                        <hr />
                        <li>Building a healthy society and ensuring their access to health sectors</li>
                        <hr />
                    </ul>
                </div>
                <div class="col-sm-6">
                    <h3><b><u>Book an Appointment</u></b></h3><br>
                    <div class="row" style="background-image:url(images/ap02.jpg);background-size:100% 100%;">
                        ...
                        <div class="col-sm-8" style="background:rgba(192,192,192,0.6);">
                            ...
                            <form action="book_op.php" method="post"
                                ...
                                <input type="text" class="form-control" id="slider_fname" name="name"
                                    placeholder="full Name  ( required )" required><br>

                                <input type="text" id="slider_phone" name="phone" class="form-control"
                                    placeholder="Phone (required)" onKeyPress="if(this.value.length==10) return false;"
                                    min="10" required><br>
                                ...
                                <left>
                                    <p style="font-weight:bold;color:#FF0000"> Please Enter Appoitment Date Only </p>
                                    </center><br>
                                    <input type="submit" name="save" id="slider_book_apo" class="btn btn-info"
                                        value="Submit">
                            </form>
...
<div class="container">
    <div class="row" style="margin-top:50px">
        ...
        <br>
        <div class="col-sm-12" style="background:rgba(0,0,0,0.40);text-align:justify;padding:16px;color:white">
            <p>Arogya Gramin Healthcare Foundation is ISO 9001: 2015 certified and registered under the Government of
                Indian Act 2013.</p>
            <br>
            <p>This organization is working within the Government of India to make healthcare facilities reach more and
                more people at a lower cost.</p>
            <br>
            <p>
                Our organization is fully operational in rural and urban areas and we are trying to establish our branch
                in different areas of the country.
            </p>
            <br>
            <button class="btn btn-info" onclick="window.location.href='about_us.php'">Read More</button>

        </div>
        <div class="col-sm-12" style="border:3px solid gray;"></div>
    </div>
</div>
    ...
    <div class="row" style="margin-top:50px">
            ...
            <div style="box-shadow:0px 10px 10px 0px;width:96%">
                <div style="width:98%;margin-top:20px;margin-bottom:20px;">
                    <center>
                        ...
                        <br>
                        <span>
                            We are tieing up with hospitals to make it easy to take an appointment booking with directly
                            through our health centres.
                        </span>
                        <hr>
                    </center>
                </div>
            ...
            <div style="box-shadow:0px 10px 10px 0px;width:96%">
                <div style="width:98%;margin-top:20px;margin-bottom:20px;">
                    <center>
                        ...
                        <br>
                        <span>
                            We connect all types of labs with the organization and provide tests at discount rates to
                            the people..
                        </span>
                        <hr>
                    </center>
            ...
            <div style="box-shadow:0px 10px 10px 0px;width:96%">
                <div style="width:98%;margin-top:20px;margin-bottom:20px;">
                    <center>
                        ...
                        <br>
                        <span>
                            Through Arogya Gramin Health Card, you can avail all the affordable health services by
        ...
        <div class="col-sm-4" style="margin-top:20px;cursor:pointer" onclick="window.location.href=''">
            <div style="box-shadow:0px 10px 10px 0px;width:96%">
                <div style="width:98%;margin-top:20px;margin-bottom:20px;">
                    <center>
                        <h4><b>Yoga Kendra</b></h4>
                        <br>
                        <span>
                            To build a healthy society we are also establishing yoga Kendra with the help of BPO's of
...
<div class="container-fluid">
    <div class="row" style="margin-top:50px">
        <center>
            <h3><u><b>Our Founder</b></u></h3>
        </center>
        <br>

        <div class="col-sm-3" style="margin-top:20px;">
            <center>
                <img src="assets/images/team/a1.jpeg" alt="" style="width:90%;border:5px solid grey;height:280px;">
                <hr>
                <h4><b>Vikash Kumar</b></h4>
                <span>(Founder & CEO) 7 years of work experience and knowledge of 10 projects which are currently
        ...
        <div class="col-sm-3" style="margin-top:20px;">
            <center>
                <img src="assets/images/team/a2.jpeg" alt="" style="width:90%;border:5px solid grey;height:280px;">
                <hr>
                <h4><b>Avnish Kumar</b></h4>
        ...
        <div class="col-sm-3" style="margin-top:20px;">
            <center>
                <img src="assets/images/team/a4.jpg" alt="" style="width:90%;border:5px solid grey;height:280px;">
                <hr>
                <h4><b>Vikram Kumar</b></h4>
        ...
        <div class="col-sm-3" style="margin-top:20px;">
            <center>
                <img src="assets/images/team/a3.jpeg" alt="" style="width:90%;border:5px solid grey;height:280px;">
                <hr>
                <h4><b>Amit Kumar</b></h4>
        ...
        <!--
			<div class="col-sm-3" style="margin-top:20px;">
			<center>
			<img src="assets/images/team/z3.jpeg" alt="" style="width:90%;border:5px solid grey;height:280px;"><hr>
			<h4><b>Rajeev Kumar</b></h4>
			<span>State Partner (Uttar Pradesh)</span><hr>
			</center>
		</div>
		<div class="col-sm-3" style="margin-top:20px;">
			<center>
			<img src="assets/images/team/z4.jpeg" alt="" style="width:90%;border:5px solid grey;height:280px;"><hr>
			<h4><b>Samir Khan</b></h4>
			<span>State Partner (Madhya Pradesh Pradesh)</span><hr>
			</center>
		</div>-->
    </div>
</div>
...
<div class="container-fluid">
    <div class="row" style="margin-top:50px">
        <center>
            <h3><u><b>Our Partners</b></u></h3>
        </center>
        <br>

        <div class="col-sm-3" style="margin-top:20px;">
            <center>
                <img src="assets/images/team/z3.jpeg" alt="" style="width:90%;border:5px solid grey;height:280px;">
                <hr>
                <h4><b>Rajeev Kumar</b></h4>
                <span>State Partner (Uttar Pradesh)</span>
                <hr>
            </center>
        </div>
        <div class="col-sm-3" style="margin-top:20px;">
            <center>
                <img src="assets/images/team/z4.jpeg" alt="" style="width:90%;border:5px solid grey;height:280px;">
                <hr>
                <h4><b>Samir Khan</b></h4>
                <span>State Partner (Madhya Pradesh)</span>
                <hr>
            </center>
        </div>
    </div>
    ...
    <div class="row" style="margin-top:50px">
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				echo "<div class='col-sm-4' style='margin-top:20px;'><div style='box-shadow:0px 10px 10px 0px;width:96%;border-radius:6px;height:300px'><div style='width:98%;margin-top:20px;margin-bottom:20px;margin-left:7px;word-wrap:break-word;'><h4><br><b>" . $row['heading'] . "</b></h4><br><span >&nbsp;&nbsp;" . $row['parpas'] . "</span><br><br><span><b></b>&nbsp;&nbsp;" . $row['link'] . "</span><hr><a href='allnotification.php' class='btn btn-success'>Read More</a><hr></div></div></div>";
			}
		} else {
			echo "0 results";
		}
...
<div class="container">
    <div class="row" style="margin-top:50px">
        <center>
            <h3><u><b>Meet Our Partners, Member, Associate & Certification</b></u></h3>
        </center>
        <br>
        <marquee>
            <div class="our_partners_slider_item"> <img src="assets/images/partner/1.jpg" alt="" width="100"
                    height="70" /> </div>
            <div class="our_partners_slider_item"> <img src="assets/images/partner/2.png" alt="" width="100"
                    height="70" /> </div>
            <div class="our_partners_slider_item"> <img src="assets/images/partner/3.png" alt="" width="100"
                    height="70" /> </div>
            <div class="our_partners_slider_item"> <img src="assets/images/partner/4.png" alt="" width="100"
                    height="70" /> </div>
            <div class="our_partners_slider_item"> <img src="assets/images/partner/5.jpg" alt="" width="100"
                    height="70" /> </div>
            <div class="our_partners_slider_item"> <img src="assets/images/partner/6.png" alt="" width="100"
                    height="70" /> </div>
            <div class="our_partners_slider_item"> <img src="assets/images/partner/7.png" alt="" width="100"
                    height="70" /> </div>
        </marquee>
    </div>
</div>
<!--<div class="container-fluid">
    <div class="row" style="background:black;color:white;margin-bottom:20px;">
        <div class="col-sm-12">
        <center><br> The Best Health Mission Ensure good health of your family with lifesaving health card Use your family <br> health card in your hospital and in the lab</center>
        </div>
        <div class="container" >
        <div class="col-sm-3" style="margin-top:50px;">
          <center><i class="fa fa-smile-o" style="font-size:60px;"></i><br>
        <p style="font-size:20px;font-family: cursive;">1,054</p>
        <p><b>HAPPY USERS</b></p>
        </center>
        </div>
        <div class="col-sm-3" style="margin-top:50px;">
          <center><i class="fa fa-globe" style="font-size:60px;"></i><br>
        <p style="font-size:20px;font-family: cursive;">875</p>
        <p><b>TOTAL HOSPITAL</b></p>
        </center>
        </div>
        <div class="col-sm-3" style="margin-top:50px;">
          <center><i class="fa fa-user-plus" style="font-size:60px;"></i><br>
        <p style="font-size:20px;font-family: cursive;">1,248</p>
        <p><b>PATIENT REACHED</b></p>
        </center>
        </div>
        <div class="col-sm-3" style="margin-top:50px;">
          <center><i class="fa fa-medkit" style="font-size:60px;"></i><br>
        <p style="font-size:20px;font-family: cursive;">54</p>
