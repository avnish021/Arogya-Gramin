    ...
    <div class="container">
        <div class="page-content text-center">
            ...
            <p>Grat to look you here! Apply your Arogya Gramin Card now to avail all affordable healthcare services.
                <br> Your card will be delivered throughout the Email you are providing.</p>
...
<div class="row">
    ...
    <div class="container">
                        ...
                        <form id="personal" enctype="multipart/form-data" name="personal" action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="block" type="text" class="form-control" placeholder="Enter Block Name"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input name="pin" type="number" class="form-control" placeholder="Enter Pin Code"
        ...
        <div class="row mt-5">
            ...
            <div class="col-12 d-flex justify-content-center">
                <a href="https://www.arogyagramin.in/2022/03/blog-post.html" target="_blank"
                    class="btn btn-danger mr-2">Read More Hindi</a>
