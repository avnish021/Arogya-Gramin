...
{	
    ...
    try {
        $edit = mysqli_query($conn,"update volunteer set name='$name', email='$email', phone='$phone', dob='$dob', full_address='$full_address', passowrd='$password', gander='$gander', status='$status' where id='$id'");
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <label>Email</label>
              ...
              <input id="uemail" name="email" type="text" class="form-control" value='<?php echo $data['email'] ?>'>
          <br>
          </div>
          <div class="col-sm-6">
            <label>Phone</label>
