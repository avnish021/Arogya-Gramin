         ...
         <!-- <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">Check Order</a></li>
              </ul>
            </div>
          </li>
        </ul>
...
<div class="container-fluid">
 ...
 <div class="container-fluid">
  ...
  <table class="styled-table" style="padding:0;margin:0;">
  <thead>
      <tr>
        <th>Sr.No.</th>
        <th>Name</th>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row['id']."</td><td>".$row['name']."</td><td>".$row['email_1']."</td><td>".$row['phone']."</td><td>".$row['subject']."</td><td>".$row['message']."</td><td>".$row['rdt']."</td><td><center><a href='send_message.php?id=".$row['id']."'><button class='btn btn-info btn-small' style'padding:0; font-size:5px;'>Reply</button></a></center></td></tr>";
    }
} else {
    echo "0 results";
}
