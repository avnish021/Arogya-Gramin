...
<div class="page-content">
              ...
              <h3>Arogya Sathi Medical Tie-Up Form</h3>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr style='color:white;background:green'><td style='color:white;background:green'>".$row['id']."</td><td>".$row['mstore']."</td><td>".$row['regis']."</td><td>".$row['status']."</td><td><a href='edit_lab_hospital_medical.php?id=".$row['id']."' class='btn btn-info'><i class='fa fa-edit'></i></a></td></tr>";
    }
} else {
    echo "0 results";
}
