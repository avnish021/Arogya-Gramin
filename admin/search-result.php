...
if($type=="personal"){
    ...
    $table="familyhealthcard";

}else{

    $table="personalhealthcard";
...
if (isset($_GET["processEU"])) {
    ...
    foreach ($all_ids as $id) {
        ...
        $query = "UPDATE `$table` SET `card_status`='Approve' WHERE `id`='$id'";
...
if (isset($_GET["processDU"])) {
    ...
    foreach ($all_ids as $id) {
        ...
        $query = "UPDATE `$table` SET `card_status`='Disapprove' WHERE `id`='$id'";
...
// $date = date('d-m-Y', $timestamp);
   ...
   if($type=="personal"){
    ...
    $order_query = "SELECT * FROM `personalhealthcard` WHERE `date` BETWEEN '$fdate' AND '$ldate' AND `card_status` = '$status' AND `author` = '$volunteer'";

    }else{

    $order_query = "SELECT * FROM `familyhealthcard` WHERE `date` BETWEEN '$fdate' AND '$ldate' AND `card_status` = '$status' AND `author` = '$volunteer'";
        ...
        <div class="container-fluid" style="padding-right:0px!important; padding-left:0px!important;">
            ...
            <body>
                ...
                <div id="result">
                    ...
                    <h6>Showing results: From <?php echo $fdate; ?> to <?php echo $ldate; ?> Volunteer ID is <?php echo $volunteer; ?> and Status is <?php echo $status; ?>.</h6>
